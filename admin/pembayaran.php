...
<?php 
	...
	if(isset($_POST['hapusmetode']))
	{
		...
		$hapus = mysqli_query($conn,"delete from pembayaran where idmetode='$idm' ");
		if ($hapus){
    ...
    if(isset($_POST['updatemetode']))
	{
		...
		$update = mysqli_query($conn,"update pembayaran set metode='$metodebaru',  norek='$norek', an='$an', logo='$logo'  where idmetode='$idm' ");
		if ($update){
		header('location:pembayaran.php');
		} else { 
            echo 'gagal update';
            ...
            <div class="main-content-inner">
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from pembayaran order by idmetode ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td> <a href="#" class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#edit"><i class="fa fa-pencil"></i> Edit</a>
                                                        <a href="#" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#delete"><i class="fa fa-trash"></i> Delete</a></td>
												</tr>		
               ...
               <div class="modal fade" id="delete">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <button type="submit" class="btn btn-success" name="hapusmetode">Hapus</button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
							...
							<form method="post">
								<div class="form-group">
									...
									<input name="metode" type="text" class="form-control" placeholder="Nama Metode"  required autofocus>
								</div>
								<div class="form-group">
									<label>No. Rekening</label>
									<input name="norek" type="text" class="form-control" placeholder="Norek"  >
								</div>
								<div class="form-group">
									<label>Atas Nama</label>
									<input name="an" type="text" class="form-control" placeholder="Atas nama"  >
								</div>
                                <div class="form-group">
									<label>URL Logo</label>
									<input name="logo" type="text" class="form-control" placeholder="Logo">
								</div>
                                ...
                                <input type="hidden" name="id" value="<?=$idm;?>">
                                                            ...
                                                            <button type="submit" class="btn btn-success" name="updatemetode">Save</button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
