...
<?php 
	...
	{
		$emailbaru = $_POST['emailbaruadmin'];
        $pass = password_hash($_POST['passwordbaru'], PASSWORD_DEFAULT); 
        
        $idnya= $_POST['id'];

			  
		$update = mysqli_query($conn,"update login set  email='$emailbaru',  password='$pass' where userid='$idnya' ");
		if ($update){
		header('location:user.php');
		} else { 
            echo 'gagal update';
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="modal-footer">
								...
								<input name="addadmin" type="submit" class="btn btn-primary" value="Simpan">
							</div>
						</form>
					</div>
				</div>
               ...
               <div class="modal fade" id="delete">
                                                ...
                                                <div class="modal fade" id="edit">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="email"  name="emailbaruadmin" class="form-control" placeholder="Email" required autofocus >

                                                        

                                                            <label for="password">Password</label>
                                                            <input type="password"  name="passwordbaru" class="form-control" placeholder="Password"required autofocus >
                                                            <input type="hidden" name="id" value="<?=$id;?>">
                                                            ...
                                                            <button type="submit" class="btn btn-success" name="updateadmin">Save</button>
                                                            </div>
                                                            </form>
                                                        </div>
                                                        </div>
