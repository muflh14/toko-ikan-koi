...
<?php 
    ...
    if(isset($_POST['editkategori']))
	{
        ...
        $namakatbaru= $_POST['namakategori'];
        $id= $_POST['id'];

			  
		$update = mysqli_query($conn,"update kategori set namakategori='$namakatbaru' where idkategori='$id' ");
		if ($update){
			header('location:kategori.php');
		} else { 
            echo 'gagal update';
			...
			<div id="myModal" class="modal fade">
               ...
               <div class="modal fade" id="delete">
							...
							<form method="post">
								<div class="form-group">
									<label>Nama Kategori</label>
									<input name="namakategori" type="text" class="form-control" placeholder="Nama Kategori" >
                                    <input type="hidden" name="id" value="<?=$id;?>">
								</div>
