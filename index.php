	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">TOKOKU</a></h1>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			<li>
				<img src="images/koi4.jpg" alt=""  />
			</li>
			<li>
				<img src="images/koi6.jpg" alt=""  />
			</li>
			
			<li>
				<img src="images/koi3.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i> Jakarta.</li>
